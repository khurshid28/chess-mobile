      ...
      child: Column(
        ...
        children: [
          ...
          GridView.count(
            ...
            children: [
              _buildTimeButton(context, '1 min', 'Bullet', 60, lobbyProvider, isSearching),
              _buildTimeButton(context, '3 min', 'Blitz', 180, lobbyProvider, isSearching),
              _buildTimeButton(context, '5 min', 'Blitz', 300, lobbyProvider, isSearching),
              _buildTimeButton(context, '10 min', 'Rapid', 600, lobbyProvider, isSearching),
              _buildTimeButton(context, '15 min', 'Rapid', 900, lobbyProvider, isSearching),
              _buildTimeButton(context, '20 min', 'Rapid', 1200, lobbyProvider, isSearching),
            ],
          ),
        ],
      ),
